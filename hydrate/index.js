...
/*!
 Stencil Mock Doc v3.4.0-dev.1686857656.ab3da27 | MIT Licensed | https://stenciljs.com
 */
...
function hydrateApp(e, t, o, n, s) {
 ...
 try {
  ...
  e.document.createElement = function t(o) {
   ...
   return f(s), s;
  }, p = 0, plt.$resourcesUrl$ = new URL(t.resourcesUrl || "./", doc.baseURI).href, 
  function e(t) {
...
const createTime = (e, t = "") => {
 return () => {};
}, isComplexType$1 = e => "object" == (e = typeof e) || "function" === e, h$1 = (e, t, ...o) => {
 console.log(`h::nodeName ${JSON.stringify(e)}`), console.log(`h::vnodeData ${JSON.stringify(t)}`), 
 console.log(`h::children ${o}`);
 let n = null, l = null, a = !1, r = !1;
 const i = [], d = t => {
  for (let o = 0; o < t.length; o++) console.log(`h::walk::i=${o}`), n = t[o], Array.isArray(n) ? (console.log("h::walk::childIsArray - recurse!"), 
  d(n)) : null != n && "boolean" != typeof n && (console.log(`h::walk::child is not bool, is ${JSON.stringify(n)}`), 
  (a = "function" != typeof e && !isComplexType$1(n)) ? (console.log(`h::walk::coerce to string - simple is ${a}`), 
  n = String(n)) : BUILD.isDev   , 
...
}, Host$1 = {}, isHost = e => e && e.$tag$ === Host$1, clientHydrate = (e, t, o, n, s, l, a) => {
 let r, i, d, c;
 if (1 === l.nodeType) {
...
}, parsePropertyValue = (e, t) => null == e || isComplexType$1(e) ? e : e, emitEvent = (e, t, o) => {
 const n = plt.ce(t, o);
...
const createElm = (e, t, o, n) => {
 ...
 const o = e.$hostElement$, s = e.$vnode$ || newVNode$1(null, null), l = isHost(t) ? t : h$1(null, null, t);
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  if (1 & t.$flags$) ; else {
   ...
   if (t.$flags$ |= 1, (n = e.getAttribute("s-id"), n)) {
    ((e, t, o, n) => {
     const s = createTime("hydrateClient", t), l = e.shadowRoot, a = [], r = null, i = n.$vnode$ = newVNode$1(t, null);
...
const h = (nodeName, vnodeData, ...children) => {
    console.log(`h::nodeName ${JSON.stringify(nodeName)}`);
    console.log(`h::vnodeData ${JSON.stringify(vnodeData)}`);
    console.log(`h::children ${children}`);
    let child = null;
    let slotName = null;
    let simple = false;
    ...
    const walk = (c) => {
        for (let i = 0; i < c.length; i++) {
            console.log(`h::walk::i=${i}`);
            child = c[i];
            if (Array.isArray(child)) {
                console.log(`h::walk::childIsArray - recurse!`);
                walk(child);
            }
            else if (child != null && typeof child !== 'boolean') {
                console.log(`h::walk::child is not bool, is ${JSON.stringify(child)}`);
                if ((simple = typeof nodeName !== 'function' && !isComplexType(child))) {
                    console.log(`h::walk::coerce to string - simple is ${simple}`);
                    child = String(child);
                }
...
class AppRoot {
  ...
  render() {
    return h(Host, null, "Hello World");
  }
